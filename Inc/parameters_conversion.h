...
#define SYS_TICK_FREQUENCY                  (uint16_t)1000
...
#define RESISTOR_OFFSET                     0.08 /* computed resitance offset to compensate error meaasuremnt due to board */
...
#define DC_CURRENT_RS_MEAS                  ((1.6) * 80) / 100 /* Maximum level of direct current = 80% of Max Board current */
