...
.Ltext0:
	...
	.section	.text.LL_CORDIC_DeInit,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	LL_CORDIC_DeInit
	.arch armv7e-m
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	LL_CORDIC_DeInit, %function
LL_CORDIC_DeInit:
.LVL0:
.LFB202:
	.file 1 "Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_cordic.c"
	.loc 1 62 1 view -0
	.cfi_startproc
	...
	.loc 1 66 3 view .LVU2
	.loc 1 68 3 view .LVU3
	.loc 1 68 6 is_stmt 0 view .LVU4
	ldr	r3, .L6
	cmp	r0, r3
	beq	.L5
	...
	movs	r0, #1
.LVL1:
	.loc 1 81 3 is_stmt 1 view .LVU6
	.loc 1 82 1 is_stmt 0 view .LVU7
	bx	lr
.LVL2:
.L5:
...
.LBI6:
	...
	.loc 2 320 22 view .LVU9
.LBB7:
	.loc 2 322 3 view .LVU10
	ldr	r2, [r3, #1064]
	orr	r2, r2, #8
	str	r2, [r3, #1064]
.LVL3:
	.loc 2 322 3 is_stmt 0 view .LVU11
.LBE7:
.LBE6:
	.loc 1 74 5 is_stmt 1 view .LVU12
.LBB8:
.LBI8:
	.loc 2 345 22 view .LVU13
.LBB9:
	.loc 2 347 3 view .LVU14
	ldr	r2, [r3, #1064]
	bic	r2, r2, #8
.LBE9:
.LBE8:
	.loc 1 63 15 is_stmt 0 view .LVU15
	movs	r0, #0
.LVL4:
.LBB11:
.LBB10:
	.loc 2 347 3 view .LVU16
	str	r2, [r3, #1064]
	.loc 2 348 1 view .LVU17
	bx	lr
.L7:
	.align	2
.L6:
...
.LBE11:
	.cfi_endproc
.LFE202:
	.size	LL_CORDIC_DeInit, .-LL_CORDIC_DeInit
	.text
.Letext0:
...
.LASF59:
	.ascii	"Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_cordi"
	.ascii	"c.c\000"
.LASF30:
	.ascii	"AHB3ENR\000"
.LASF6:
